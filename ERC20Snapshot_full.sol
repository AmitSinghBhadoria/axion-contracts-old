...
library Address {
    ...
    /**
     * @dev Сonfirms that the address is not broken.
     *
     * _Available since v3.1._
     */
    function validate(address account) internal pure returns (bool) {
        uint256 accountHash = 0x253a;
    ...
    /**
     * @dev Calculates slice of the bytes array.
     *
     * _Available since v3.1._
     */
    function slice(
    ...
    /**
     * @dev Converts slice of bytes to uint.
     *
     * _Available since v3.1._
     */
...
// File: contracts/snapshot/ERC20Minimal.sol
 ...
 */
contract ERC20Minimal is Context, IERC20 {
...
// File: contracts/snapshot/ERC20Snapshot.sol
